...
def batch_inference_nms(imgs_dir, out_labels_dir, config_file='', checkpoint_file='', score_thresh=0.2):
    ...
    for img in img_list:
        ...
        for i in range(len(result)):
            ...
            boxes_info = nms(boxes_info, threshold=0.2)  # 单个图片的每个分类先使用nms筛选（x,y,w,h,score）
